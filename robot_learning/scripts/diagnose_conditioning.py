...
from robot_learning.models.policy import GoalConditionedBCPolicy, TinyVLAPolicy
...
def main():
    ...
    parser.add_argument("--checkpoint", type=str, default="outputs/robot_learning/checkpoints/vla_bc.pt")
    parser.add_argument("--dataset", type=str, default="outputs/robot_learning/rollouts/sim_vla_rollouts.h5")
