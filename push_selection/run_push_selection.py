...
-----
    ...
    python run_push_selection.py --output-dir outputs/push_selection
...
CUSTOM_OBJECT_DIR = REPO_ROOT / "mujoco_irb120" / "robot" / "assets" / "objects"
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=REPO_ROOT / "outputs" / "push_selection",
        metavar="DIR",
        help="Directory for output PNG files. Default: outputs/push_selection/",
    )
